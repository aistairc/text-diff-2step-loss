...
class DataCollatorForLanguageModeling(DataCollatorMixin):
    ...
    def __post_init__(self):
        ...
        self.l_bracket_id = self.tokenizer.convert_tokens_to_ids("(")
        self.r_bracket_id = self.tokenizer.convert_tokens_to_ids(")")
    ...
    def torch_mask_tokens(self, inputs: Any, special_tokens_mask: Optional[Any] = None) -> Tuple[Any, Any]:
        ...
        # For ctree
        #l_bracket_mask = torch.where(labels == self.l_bracket_id, True, False)
        #r_bracket_mask = torch.where(labels == self.r_bracket_id, True, False)
        #special_tokens_mask = special_tokens_mask | l_bracket_mask | r_bracket_mask
